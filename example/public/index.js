...
////////////////////////////////
function Gameplay(canvas, lastStatistics) {
	this.canvas = canvas;
...
Gameplay.prototype.onNextStep = function(callback) {
	this.onNextStepFunc = callback;
}
...
$(document).ready(function() {
	...
	function newGame(statistics, button) {
		gameplay = new Gameplay($("#gameScreen")[0], statistics);
		...
		gameplay.onNextStep(function(newStatistics) {
			$.post('/save-statistics', {statistics: newStatistics});
		})
	...
	$('#go').live('click', function() {
		...
		// getting last statistics
		$.get('/get-statistics', function(lastStatistics) {
			newGame(lastStatistics, that);
		});
